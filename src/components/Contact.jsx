...
const Contact = () => {
  ...
  return (
    <motion.div className='flex flex-row items-center justify-center pb-10 space-x-28 l-tablet:space-x-20 tablet:flex-col tablet:space-x-0'>
        ...
        <div className='flex flex-col items-center text-xl space-y-14 text-center tablet:pt-10 pb-10 lg:pr-8 tablet:pr-20'>
          <p>
            ...
            <br />
            <a href="mailto:k.nowicki24@gmail.com" className='text-red-600 font-bold'>k.nowicki24@gmail.com</a>
          </p>
          <p>
